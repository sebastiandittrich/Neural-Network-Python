...
{
    { (char *)"NeuralNetwork", MOD_INIT_NAME( NeuralNetwork ), NULL, 0, NUITKA_COMPILED_MODULE },
    ...
    { (char *)"numpy.distutils", NULL, &constant_bin[ 1447915 ], 713, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.__config__", NULL, &constant_bin[ 1448628 ], 1841, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.__version__", NULL, &constant_bin[ 1450469 ], 393, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.ccompiler", NULL, &constant_bin[ 1450862 ], 21760, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command", NULL, &constant_bin[ 1472622 ], 1372, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.command.autodist", NULL, &constant_bin[ 1473994 ], 2777, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.bdist_rpm", NULL, &constant_bin[ 1476771 ], 1155, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build", NULL, &constant_bin[ 1477926 ], 2600, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_clib", NULL, &constant_bin[ 1480526 ], 8938, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_ext", NULL, &constant_bin[ 1489464 ], 13860, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_py", NULL, &constant_bin[ 1503324 ], 1672, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_scripts", NULL, &constant_bin[ 1504996 ], 2003, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_src", NULL, &constant_bin[ 1506999 ], 23253, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.config", NULL, &constant_bin[ 1530252 ], 13580, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.config_compiler", NULL, &constant_bin[ 1543832 ], 5870, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.develop", NULL, &constant_bin[ 1549702 ], 1110, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.egg_info", NULL, &constant_bin[ 1550812 ], 1051, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install", NULL, &constant_bin[ 1551863 ], 2763, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_clib", NULL, &constant_bin[ 1554626 ], 2221, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_data", NULL, &constant_bin[ 1556847 ], 1305, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_headers", NULL, &constant_bin[ 1558152 ], 1352, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.sdist", NULL, &constant_bin[ 1559504 ], 1302, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.compat", NULL, &constant_bin[ 1560806 ], 580, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.conv_template", NULL, &constant_bin[ 1561386 ], 9694, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.core", NULL, &constant_bin[ 1571080 ], 5940, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.cpuinfo", NULL, &constant_bin[ 1577020 ], 43774, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.environment", NULL, &constant_bin[ 1620794 ], 3487, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.exec_command", NULL, &constant_bin[ 1624281 ], 18302, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.extension", NULL, &constant_bin[ 1642583 ], 2571, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.fcompiler", NULL, &constant_bin[ 1645154 ], 33878, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.from_template", NULL, &constant_bin[ 1679032 ], 8506, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.info", NULL, &constant_bin[ 1687538 ], 378, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.lib2def", NULL, &constant_bin[ 1687916 ], 4002, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.log", NULL, &constant_bin[ 1691918 ], 3083, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.mingw32ccompiler", NULL, &constant_bin[ 1695001 ], 16756, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.misc_util", NULL, &constant_bin[ 1711757 ], 77151, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.npy_pkg_config", NULL, &constant_bin[ 1788908 ], 15360, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.numpy_distribution", NULL, &constant_bin[ 1804268 ], 1082, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.system_info", NULL, &constant_bin[ 1805350 ], 79453, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.unixccompiler", NULL, &constant_bin[ 1884803 ], 3814, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.dual", MOD_INIT_NAME( numpy$dual ), NULL, 0, NUITKA_COMPILED_MODULE },
    { (char *)"numpy.f2py", NULL, &constant_bin[ 1888617 ], 2089, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.f2py.__version__", NULL, &constant_bin[ 1890706 ], 480, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.auxfuncs", NULL, &constant_bin[ 1891186 ], 31012, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.capi_maps", NULL, &constant_bin[ 1922198 ], 22213, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.cb_rules", NULL, &constant_bin[ 1944411 ], 16759, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.cfuncs", NULL, &constant_bin[ 1961170 ], 37520, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.common_rules", NULL, &constant_bin[ 1998690 ], 5659, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.crackfortran", NULL, &constant_bin[ 2004349 ], 88488, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.diagnose", NULL, &constant_bin[ 2092837 ], 4325, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f2py2e", NULL, &constant_bin[ 2097162 ], 20621, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f2py_testing", NULL, &constant_bin[ 2117783 ], 1779, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f90mod_rules", NULL, &constant_bin[ 2119562 ], 8704, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.func2subr", NULL, &constant_bin[ 2128266 ], 7970, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.rules", NULL, &constant_bin[ 2136236 ], 38645, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.use_rules", NULL, &constant_bin[ 2174881 ], 3732, NUITKA_BYTECODE_FLAG },
    ...
    { (char *)"numpy.testing", NULL, &constant_bin[ 2178613 ], 787, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.testing.decorators", NULL, &constant_bin[ 2179400 ], 9729, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.noseclasses", NULL, &constant_bin[ 2189129 ], 11091, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.nosetester", NULL, &constant_bin[ 2200220 ], 16057, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.utils", NULL, &constant_bin[ 2216277 ], 63074, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.version", MOD_INIT_NAME( numpy$version ), NULL, 0, NUITKA_COMPILED_MODULE },
    { (char *)"pkg_resources", NULL, &constant_bin[ 2279351 ], 113413, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"pkg_resources.extern", NULL, &constant_bin[ 2392764 ], 2928, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools", NULL, &constant_bin[ 2395692 ], 7742, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.archive_util", NULL, &constant_bin[ 2403434 ], 6157, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command", NULL, &constant_bin[ 2409591 ], 846, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.command.bdist_egg", NULL, &constant_bin[ 2410437 ], 17556, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.bdist_rpm", NULL, &constant_bin[ 2427993 ], 1906, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.develop", NULL, &constant_bin[ 2429899 ], 7274, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.easy_install", NULL, &constant_bin[ 2437173 ], 81149, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.egg_info", NULL, &constant_bin[ 2518322 ], 20282, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.install", NULL, &constant_bin[ 2538604 ], 4945, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.install_scripts", NULL, &constant_bin[ 2543549 ], 2820, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.sdist", NULL, &constant_bin[ 2546369 ], 6793, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.setopt", NULL, &constant_bin[ 2553162 ], 6048, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.depends", NULL, &constant_bin[ 2559210 ], 7214, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.dist", NULL, &constant_bin[ 2566424 ], 34886, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.extension", NULL, &constant_bin[ 2601310 ], 2406, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.extern", NULL, &constant_bin[ 2603716 ], 330, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.msvc9_support", NULL, &constant_bin[ 2604046 ], 2093, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.package_index", NULL, &constant_bin[ 2606139 ], 39608, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py26compat", NULL, &constant_bin[ 2645747 ], 976, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py27compat", NULL, &constant_bin[ 2646723 ], 735, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py31compat", NULL, &constant_bin[ 2647458 ], 2367, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.sandbox", NULL, &constant_bin[ 2649825 ], 18673, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.ssl_support", NULL, &constant_bin[ 2668498 ], 7860, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.unicode_utils", NULL, &constant_bin[ 2676358 ], 1464, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.utils", NULL, &constant_bin[ 2677822 ], 535, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.version", NULL, &constant_bin[ 2678357 ], 314, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.windows_support", NULL, &constant_bin[ 2678671 ], 1266, NUITKA_BYTECODE_FLAG },
